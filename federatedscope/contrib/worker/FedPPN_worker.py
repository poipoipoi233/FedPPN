...
class FedPPN_Server(Server):
    def __init__(self,
                 ...
                 strategy=None,
                 **kwargs):
        super(FedPPN_Server, self).__init__(ID, state, config, data, model, client_num,
...
class FedPPN_Client(Client):
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(FedPPN_Client, self).__init__(ID, server_id, state, config, data, model, device,
...
def call_my_worker(method):
    if method == 'fedppn':
        worker_builder = {'client': FedPPN_Client, 'server': FedPPN_Server}
        return worker_builder


register_worker('fedppn', call_my_worker)
